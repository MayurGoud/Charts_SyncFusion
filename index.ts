...
var multiParentData = [
  { 'Name': 'node11asfdasfasdf', 'ReportingPerson': [''], 'fillColor': '#e7704c', 'border': '#c15433' },
  ...
  { 'Name': 'node21', 'ReportingPerson': [''], 'fillColor': '#e7704c', 'border': '#c15433' },
  ...
  { 'Name': 'node31', 'ReportingPerson': [''], 'fillColor': '#e7704c', 'border': '#c15433' },
  { 'Name': 'node114', 'ReportingPerson': ['node11asfdasfasdf', 'node21', 'node31'], 'fillColor': '#f3904a', 'border': '#d3722e' },
...
diagram = new ej.diagrams.Diagram({
  ...
  layout: {
    ...
    horizontalSpacing: 40, verticalSpacing: 75, orientation: 'TopToBottom',
